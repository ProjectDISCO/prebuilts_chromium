...
$(shell mkdir -p out/target/product//system/app/webview/lib/arm/)
$(shell cp -r $(LOCAL_PATH)/app/webview/lib/arm/libwebviewchromium.so out/target/product//system/app/webview/lib/arm/libwebviewchromium.so)
